# CLAUDE.md — frappe-healthcare (SWE-Pioneers fork)

Changes on top of upstream `frappe/healthcare` (version-16).

## Arabic i18n
- `healthcare/locale/ar.po` completed to **100% of app-owned strings** (Libyan-appropriate MSA), tagged
...
## Deploy
Built from `~/build/healthcare-custom` on the VPS (Containerfile repointed to this fork + per-app
